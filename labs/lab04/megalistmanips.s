...
mapLoop:
	...
	slli t0, t0, 2		#Hint: if p is a pointer,C compute p+index = p+sizeof(type)*index,but you shoud manully compute offset in risc-v
    add t1, t1, t0      # offset the array address by the count
    lw a0, 0(t1)        # load the value at that address into a0
	srli t0, t0, 2 		# restore t0
    addi sp, sp, -8
    sw t0, 0(sp)		#Hint:t1 will be overrite when you call mystery function
    sw t1, 4(sp)
